@extends('layouthome')
@section('content')
    <h1>Tentang Kami Donor Darah</h1>
    {!! nl2br('Apakah Anda tahu bahwa manfaat donor darah ternyata bukan hanya pada penerima donor darah tersebut, tetapi pendonor juga memiliki banyak manfaat. Tidak hanya orang yang membutuhkan donor darah saja, tetapi bagi orang yang mendonorkan darahnya banyak manfaat yang diperoleh.
